...
public class HashBruter extends Bruter 
{
	...
	private String generateHash(char[] passwordChar) 
	{
		...
		boolean ProcessHash = true; 
		String passwordString = null ; 
		String encodedPasswordInString = null ; 
		try 
		{
		...
		encodedPasswordInString = toHexString(encodedPassword);
 ...
 *
 *  CRC-16-CCITT is apparently this form :  x^{16} + x^{12} + x^{5} + 1 
 * 
 * 
